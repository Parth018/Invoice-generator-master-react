...
An Invoice creator project built with React. Add itemized items, and configure quantities, prices, tax-rates, and discounts. Download the Invoice as PDFs to your device. Uses [jspdf-react](https://www.npmjs.com/package/jspdf-react) to capture the data from the modal and covert it from canvas -> to pdf.
