...
An Invoice creator project built with React. Add itemized items - configure quantities, prices, tax, discounts. Download invoice and PDF from any of your devices. Uses [jspdf-react](https://www.npmjs.com/package/jspdf-react) to capture the data to the modal & covert it from canvas to pdf.
