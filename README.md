...
An Invoice creator project built with React. Add itemized items, & configure quantities, prices, tax, & discounts. Download invoice as a PDF for any of your devices. Uses [jspdf-react](https://www.npmjs.com/package/jspdf-react) to capture the data from the modal & covert it from canvas to pdf.
