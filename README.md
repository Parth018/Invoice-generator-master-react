...
An Invoice creator project built with React. Add itemized items, and configure quantities, prices, tax rates,& discounts. Download the invoice as a PDF for any of your devices. Uses [jspdf-react](https://www.npmjs.com/package/jspdf-react) to capture the data from the modal & covert it from canvas to pdf.
